...
saveRDS(seuList, file = "results/7374_dlpfc_seuList4.RDS")
...
saveRDS(PRECASTObj, file = "results/7374dlpfc_PRECASTObj.rds")
...
print(seuInt)
saveRDS(seuInt, file = "results/7374dlpfc_seuInt.rds")
...
write_json(benchmark_results, "results/precast_benchmark_7374.json", pretty = TRUE, auto_unbox = TRUE)
...
zellkonverter::writeH5AD(sce, "results/7374_dlpfc_seuInt.h5ad")
...
import os
import numpy as np
adata = sc.read_h5ad('results/7374_dlpfc_seuInt.h5ad')
...
adata.write('results/7374_dlpfc_seuInt_with_all_spatial.h5ad')
